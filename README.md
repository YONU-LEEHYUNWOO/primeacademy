...
- ✅ 숫자 카운트업 애니메이션
- ✅ 가로형 배너 레이아웃
- ✅ 다국어 지원 (한국어/영어) - Zustand 기반 전역 상태 관리
- ✅ 실시간 언어 전환 (새로고침 없이 즉시 반영)
- ✅ 언어 설정 로컬스토리지 저장
...
### v1.3.0 (최신)
- 🌐 다국어 지원 기능 추가 (한국어/영어)
- 🔄 Zustand 기반 전역 상태 관리로 실시간 언어 전환 구현
- 📱 헤더에 언어 선택 드롭다운 메뉴 추가 (데스크톱/모바일)
- 💾 언어 설정 로컬스토리지 자동 저장
- 🎨 모든 페이지 및 컴포넌트에 i18n 적용
- 🛡️ MetaMask 브라우저 확장 프로그램 오류 필터링 추가

### v1.2.0
- 🎨 차별점 섹션 이미지 배경색 제거 및 모달 다이얼로그 기능 추가
- 📝 차별점 카드 클릭 시 상세 설명 모달 표시
- 🎯 모달 내 상세 설명, 주요 특징, 기대 효과 섹션 추가
- 🖼️ 이미지 오버레이 제거로 더 선명한 이미지 표시
